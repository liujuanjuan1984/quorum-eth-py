...
contract PaidGroup {
  ...
  function initialize(string memory _version, uint256 _invokeFee,  uint64 _shareRatio, address _receiverAddr, string memory _name, string memory  _devloper) public {
    ...
    dappInfo = DappInfo({
      ...
      version: _version,
      developer: _devloper,
      receiver: payable(_receiverAddr),  // 平台收款地址
